...
@Composable
fun ListeningScreen(navController: NavController, viewModel: ListeningViewModel = hiltViewModel()) {
    val uiState = viewModel.uiState.collectAsState().value

    val tabs = listOf(TabItem.ListeningAcademic, TabItem.ListeningGeneralTraining)
